...
/// <summary>
/// Converts internal DTO models to public API models
/// </summary>
internal static class EnsembleDailyConverter
{
    public static EnsembleDaily? ToPublicModel(WeatherEnsembleDailyDto? dto)
    {
        ...
        // Assign to public model properties using reflection
    ...
    private static string ToPropertyName(string variableName)
    {
        ...
        // e.g., "temperature_2m_max" -> "Temperature_2m_max"
        // e.g., "windspeed_10m_mean" -> "Windspeed_10m_mean"
