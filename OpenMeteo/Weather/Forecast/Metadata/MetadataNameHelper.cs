...
internal static class MetadataNameHelper
{
    public static string GetMetadataUrlName(WeatherModelOptionsParameter weatherModel) => weatherModel switch
    {
        ...
        WeatherModelOptionsParameter.ncep_hgefs025_ensemble_mean => "ncep_hgefs025_ensemble_mean",
        WeatherModelOptionsParameter.ncep_nbm_conus => "ncep_nbm_conus",
        WeatherModelOptionsParameter.ncep_nam_conus => "ncep_nam_conus",
        WeatherModelOptionsParameter.gem_global => "cmc_gem_gdps_15km",
        ...
        WeatherModelOptionsParameter.gem_regional => "cmc_gem_rdps_10km",
        ...
        WeatherModelOptionsParameter.geosphere_arome_austria => "geosphere_arome_austria",
