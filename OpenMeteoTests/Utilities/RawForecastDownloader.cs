...
namespace OpenMeteoTests.Utilities
{
    ...
    public class RawForecastDownloader
    {
        ...
        {
            // Arrange
            var options = GetOptions(_latitude, _longitude);
        ...
        private static HourlyOptions GetHourlyOptions()
        {
            ...
            // For this test, always use detailed
            return new HourlyOptions([.. options, .. detailedPressureLevelMetrics]);
        }

        private static WeatherForecastOptions GetOptions(float latitude, float longitude)
        {
