<#
.SYNOPSIS
    Generates C# static classes from GeoJSON coverage boundary files.

.DESCRIPTION
    This script reads GeoJSON files and emits a
...
$geojsonDir  = Join-Path $repoRoot "RegionalGeoJSON"
